...
// em sistemas reais de produção. Geralmente os cálculos são feitos usando a biblioteca NewDecimal usada para cálculos com numeros decimais por que o float e double podem
// apresentar imprecisão devido à forma como os números de ponto flutuante são representados na memória do computador.
...
// $PlanoPrime = ($anoFilme >= 2000) ? 'Sim' : 'Não'; no caso a interrogação verifica a condição ($anoFilme >= 2000) e o operador de dois pontos retorna a resposta
...
// o switch case, que é uma estrutura de controle de fluxo que permite executar diferentes ações com base no valor de uma expressão. É uma forma mais simplificada e legível de 
// escrever vários blocos if/else encadeados, desde que as operações sejam somente de igualdade.
...
// count() é uma função em PHP que retorna o número de elementos em um array ou a contagem de propriedades em um objeto. É comumente usada para determinar o tamanho de um array ou para verificar se um array está vazio.
